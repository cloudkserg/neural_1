...
class NeuralNetwork {
    ...
    calcResult(i1, i2, returnAllResults = false) {
        const h1_input = this.weights.i1_h1 * i1 + this.weights.i2_h1 * i2;
        const h1 = this.activationSigmoid(h1_input);

        const h2_input = this.weights.i1_h2 * i1 + this.weights.i2_h2 * i2;
        const h2 = this.activationSigmoid(h2_input);

        const o1_input = this.weights.h1_o1 * h1 + this.weights.h2_o1 * h2;
